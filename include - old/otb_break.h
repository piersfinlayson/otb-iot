...
#define OTB_BREAK_CONFIG_STATE_CHIP_ID         5
#define OTB_BREAK_CONFIG_STATE_DEVICE_ID       6
#define OTB_BREAK_CONFIG_STATE_IP_TOGGLE       7
#define OTB_BREAK_CONFIG_STATE_IP_IPV4_ADDRESS 8
#define OTB_BREAK_CONFIG_STATE_IP_IPV4_SUBNET  9
#define OTB_BREAK_CONFIG_STATE_IP_IPV4_GATEWAY 10
#define OTB_BREAK_CONFIG_STATE_IP_IPV4_DNS1    11
#define OTB_BREAK_CONFIG_STATE_IP_IPV4_DNS2    12
#define OTB_BREAK_CONFIG_STATE_IP_IPV4_DOMAIN_NAME 13
