...
#define OTB_LED_NEO_T0H_NS      400
#define OTB_LED_NEO_T1H_NS      800
#define OTB_LED_NEO_PERIOD_NS   1250
#define OTB_LED_NEO_CLK_NS      12.5
#define OTB_LED_NEO_T0H_CLK     (uint32_t)(OTB_LED_NEO_T0H_NS    / OTB_LED_NEO_CLK_NS)
#define OTB_LED_NEO_T1H_CLK     (uint32_t)(OTB_LED_NEO_T1H_NS    / OTB_LED_NEO_CLK_NS)
#define OTB_LED_NEO_PERIOD_CLK  (uint32_t)(OTB_LED_NEO_PERIOD_NS / OTB_LED_NEO_CLK_NS)
#define OTB_LED_NEO_START_NS    10000
#define OTB_LED_NEO_RESET_NS    50000
#define OTB_LED_NEO_START_CLK   (uint32_t)(OTB_LED_NEO_START_NS / OTB_LED_NEO_CLK_NS)
#define OTB_LED_NEO_RESET_CLK   (uint32_t)(OTB_LED_NEO_RESET_NS / OTB_LED_NEO_CLK_NS)

#define OTB_LED_NEO_WAIT_CLK(START, WAIT)             \
  {                                                   \
    uint32_t __start = START;                         \
    while((soc_get_ccount() - __start) < WAIT);         \
  }
...
#ifdef OTB_LED_C
static bool otb_led_neo_lock = FALSE;
#endif // OTB_LED_C
...
#define OTB_LEB_SEQUENCE_AFTER_NUM          3
  ...
  TimerCallbackFunction_t *on_done;
