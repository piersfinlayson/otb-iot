...
def graphPower():
  ...
  details = ['DEF:power=%s:%s:AVERAGE' % (RRD_FILE, RRD_POWER),
             ...
             'GPRINT:maxpower:Maximum avg power over period\: %7.0lfW',
             'GPRINT:minpower:Minimum avg power over period\: %7.0lfW',
             'COMMENT:\s',
             'COMMENT:\s',
             'COMMENT:\s',
             'VDEF:maxcurrent=current,MAXIMUM',
             'VDEF:mincurrent=current,MINIMUM',
             'GPRINT:maxcurrent:Maximum avg current over period\: %2.2lfA',
             'GPRINT:mincurrent:Minimum avg current over period\: %2.2lfA',
             'COMMENT:\s',
             'COMMENT:\s',
             'COMMENT:\s',
             'VDEF:maxvoltage=voltage,MAXIMUM',
             'VDEF:minvoltage=voltage,MINIMUM',
             'GPRINT:maxvoltage:Maximum avg voltage over period\: %3.1lfV',
             'GPRINT:minvoltage:Minimum avg voltage over period\: %3.1lfV',
             'COMMENT:\s',
             'COMMENT:\s',
             'COMMENT:\s',
             ]
