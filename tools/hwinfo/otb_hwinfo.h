...
static struct argp_option otb_hwinfo_options[] = 
{
  ...
  {"board_type", 'b', "BOARD_TYPE", 0, "otbiot_v0_3, otbiot_v0_4, otbiot_v0_5, d1_mini, nixie_v0_2 (mz), temp_v0_2 (mz), prog_v0_2 (mz), relay_v0_2 (mz), mbus_v0_1 (mz), espi_v1_0a are allowed values"},
